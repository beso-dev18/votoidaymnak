...
Nội dung rút từ `../Bộ sell-out kit - Toàn bộ danh mục OTC (theo mẫu công ty).md`,
hình ảnh lấy từ bộ slide giới thiệu Elemis chính thức của công ty (`Presentation1.pptx`).
...
1. **Cách xử lý khi bé có rôm sảy/mụn nhọt đang có hai hướng dẫn khác nhau:**
   ...
   - Bộ slide `Presentation1.pptx`: **xoa trực tiếp** Elemis lên vùng da **1–2 phút**, sau đó tắm bé
