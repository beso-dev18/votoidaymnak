...
│   ├── VD1 - Ham da (ngang gap 3).html/.pdf/.png  ← ⭐ bản đang dùng: A4 ngang in 1 mặt, gấp chữ Z thành 3 tấm 99mm; tấm 1 là bìa: gợi ý bộ SP (cần thiết / khuyến nghị) → sản phẩm → vấn đề được giải quyết → khi nào khuyên đi khám; tấm 2 = bước 1+2, tấm 3 = bước 3 + cách dùng theo tình trạng; so sánh đối thủ dạng bảng thành phần trung tính
