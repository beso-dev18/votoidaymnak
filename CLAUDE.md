...
│   └── VD1 - Ham da (3 cot).html/.pdf/.png  ← poster A4 3 cột chuyển từ mục 1 "Hăm da" của Sell-out kit theo vấn đề da bé (bản chạy thử để duyệt mẫu; 8 mục còn lại chưa dựng). 3 cột = 3 bước, có ảnh SP (web công ty), ảnh dược liệu + triệu chứng (Wikimedia Commons)
