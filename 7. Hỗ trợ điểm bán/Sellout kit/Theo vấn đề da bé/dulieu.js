...
// (đối chiếu 15/09/2026). KHÔNG tự thêm đối thủ, thành phần hay nhận định nào ngoài file nguồn đó.
const DOITHU = {
  kem: {
    doiThu: [
      { ten: 'Bepanthen Balm (30g)',
        khacBiet: 'DKX dùng kẽm oxyd nano kết hợp rau má + ngải cứu.' },
      { ten: 'Sudocrem (60g)',
        khacBiet: 'DKX kết hợp kẽm oxyd với thảo dược (rau má, ngải cứu).' },
    ],
  ...
  tamgoi: {
    doiThu: [
      { ten: 'Dr.Papie (230ml)',
        khacBiet: 'DKX có thêm dịch chiết chanh và tinh dầu mùi.' },
      { ten: 'Kutieskin (200ml)',
        khacBiet: 'DKX có thêm dịch chiết chanh và tinh dầu mùi.' },
    ],
  ...
  gold: {
    doiThu: [
      { ten: 'Dr.Papie (230ml)',
        khacBiet: 'DKX có thêm hương nhu và kim ngân.' },
      { ten: 'Kutieskin (200ml)',
        khacBiet: 'DKX có thêm hương nhu và kim ngân.' },
    ],
  ...
  bot: {
    doiThu: [
      { ten: 'Chicco 0M+ — Ý (250ml)',
        khacBiet: 'DKX có Aquaxyl (công nghệ dưỡng ẩm sinh học).' },
    ],
    rieng: 'Aquaxyl (dưỡng ẩm sâu) — Chicco không liệt kê thành phần này.',
  },
  dau: {
    doiThu: [
      { ten: "Johnson's Baby Oil",
        khacBiet: 'DKX dùng 3 loại dầu thực vật kết hợp (cám gạo + hạnh nhân + hạt nho).' },
      { ten: 'Chicco (cám gạo)',
        khacBiet: 'DKX dùng 3 loại dầu thực vật kết hợp (cám gạo + hạnh nhân + hạt nho), không chỉ cám gạo đơn lẻ.' },
    ],
    rieng: "Kết hợp 3 loại dầu thực vật (cám gạo + hạnh nhân + hạt nho) — Johnson's dùng dầu khoáng, Chicco chỉ có cám gạo đơn lẻ.",
  },
  xit: {
    doiThu: [
      { ten: 'Remos Baby Spray (Rohto)',
        khacBiet: 'DKX 100% tinh dầu tự nhiên, không hoạt chất hoá học (Picaridin/DEET).' },
      { ten: 'Soffell',
        khacBiet: 'DKX 100% tinh dầu tự nhiên, không hoạt chất hoá học (Picaridin/DEET).' },
    ],
  ...
  gac: {
    doiThu: [
      { ten: 'Gạc răng miệng Dr.Papie (30 gói)',
        khacBiet: 'DKX có thêm rau ngót, chè xanh/cúc la mã.' },
    ],
